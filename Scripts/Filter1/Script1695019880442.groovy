...
WebUI.click(findTestObject('typehyperlink_DAIHATSU AYLA D MT 2', [(findTestData(null).getValue(1, 1)) : Lokasi, (findTestData(
                null).getValue(1, 1)) : Jenis, (findTestData(null).getValue(1, 1)) : Nama]))
